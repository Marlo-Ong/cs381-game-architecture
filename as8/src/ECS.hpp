...
namespace cs381 {
	...
	struct ComponentStorage {
		...
		ComponentStorage(size_t elementSize) : elementSize(elementSize) { data.reserve(11 * elementSize); }
	...
	struct SkiplistComponentStorage {
		...
		SkiplistComponentStorage(size_t elementSize) : elementSize(elementSize) { data.reserve(11 * elementSize); }
	...
	struct SceneView {
		...
		struct Sentinel {};
		struct Iterator {
			Scene<ComponentStorage>* scene = nullptr;
			Entity e;
